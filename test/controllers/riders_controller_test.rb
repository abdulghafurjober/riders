...
class RidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post riders_url, params: { rider: { IC: @rider.IC, Location: @rider.Location, Name: @rider.Name, Phone: @rider.Phone } }
    end
  ...
  test "should update rider" do
    patch rider_url(@rider), params: { rider: { IC: @rider.IC, Location: @rider.Location, Name: @rider.Name, Phone: @rider.Phone } }
